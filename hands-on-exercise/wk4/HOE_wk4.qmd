...
### Importing coastal outline data

```{r}
sg_sf <- st_read(dsn = "data", layer="CostalOutline")
```

### Importing master plan data
...
```{r}
#sf data is converted to sp's spatial class
...
## Converting spatial into generic sp format
...
## Generic sp format into spatstat ppp format
...
# Analyzing spatial point using L-function
